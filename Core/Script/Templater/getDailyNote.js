...
// src/scripts/Templater/getDailyNote.ts
module.exports = function(oldDateString, shift = 0) {
  const oldDate = /* @__PURE__ */ new Date(`${oldDateString}T00:00:00`);
  const newDate = new Date(oldDate.getTime() + shift * 864e5 /* days */);
